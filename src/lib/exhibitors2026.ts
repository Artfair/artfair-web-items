...
export const EXHIBITORS_2026: ArchiveExhibitor[] = [
  {name: '10 A.M. ART', cities: ['Mailand'], country: 'IT', sections: ['solo'], stand: 'D05', url: 'https://www.10amart.it'},
  {name: 'AG18 Gallery', cities: ['Wien', 'Los Angeles'], country: 'AT', sections: ['next'], stand: 'H17', url: 'https://ag18gallery.com/'},
  ...
  {name: 'Anton Janizewski', cities: ['Berlin'], country: 'DE', sections: ['next'], stand: 'D09', url: 'https://antonjanizewski.com/'},
  {name: 'AOA;87', cities: ['Berlin'], country: 'DE', sections: ['solo'], stand: 'H02', url: 'https://www.aoa-87.com/'},
  ...
  {name: 'Behncke Gallery', cities: ['München'], country: 'DE', sections: ['next'], stand: 'H19', url: 'https://behncke-gallery.com/de'},
  ...
  {name: 'Berthold Pott', cities: ['Köln'], country: 'DE', sections: ['main'], stand: 'H09', url: 'https://www.bertholdpott.com'},
  {name: 'BOA-basedonart', cities: ['Düsseldorf'], country: 'DE', sections: ['main'], stand: 'C06', url: 'https://boa-basedonart.com/'},
  {name: 'Britta Rettberg', cities: ['München'], country: 'DE', sections: ['next'], stand: 'D10', url: 'https://brittarettberg.com/'},
  ...
  {name: 'City Galerie Wien', cities: ['Wien'], country: 'AT', sections: ['friends'], stand: 'F07', url: 'https://city-galerie-wien.com/'},
  {name: 'Coelner Zimmer', cities: ['Düsseldorf'], country: 'DE', sections: ['next'], stand: 'H20', url: 'https://coelner-zimmer.de/'},
  {name: 'COSAR', cities: ['Düsseldorf'], country: 'DE', sections: ['main'], stand: 'H06', url: 'https://cosar-gallery.com/'},
  {name: 'Crone', cities: ['Wien', 'Berlin'], country: 'AT', sections: ['solo'], stand: 'H05', url: 'https://www.galeriecrone.com/'},
  ...
  {name: 'Dürst Britt & Mayhew', cities: ['Den Haag'], country: 'NL', sections: ['solo'], stand: 'G15', url: 'https://www.durstbrittmayhew.com'},
  {name: 'Elektrohalle Rhomberg', cities: ['Salzburg'], country: 'AT', sections: ['next'], stand: 'E06', url: 'https://elektrohalle-rhomberg.net'},
  {name: 'Encounter', cities: ['Lissabon'], country: 'PT', sections: ['next'], stand: 'D12', url: 'https://www.encountercontemporary.com/'},
  {name: 'Esther Schipper', cities: ['Berlin', 'Paris', 'Seoul'], country: 'DE', sections: ['main'], stand: 'D06', url: 'https://www.estherschipper.com'},
  {name: 'EXILE', cities: ['Wien', 'Berlin'], country: 'AT', sections: ['main'], stand: 'D01', url: 'https://exilegallery.org'},
  ...
  {name: 'Fuocherello', cities: ['Turin'], country: 'IT', sections: ['next'], stand: 'H15', url: 'https://fuocherello.com'},
  {name: 'Galerie 3AP', cities: ['Düsseldorf', 'Frankfurt'], country: 'DE', sections: ['next'], stand: 'H23', url: 'https://galerie-3ap.de/'},
  {name: 'Galerie Andreas Binder', cities: ['München'], country: 'DE', sections: ['main'], stand: 'I07', url: 'https://www.galerieandreasbinder.de'},
  ...
  {name: 'Galerie Dr. Dorothea van der Koelen', cities: ['Mainz', 'Venedig'], country: 'DE', sections: ['main'], stand: 'J07', url: 'https://galerie.vanderkoelen.de/'},
  {name: 'Galerie Droste', cities: ['Düsseldorf', 'Berlin', 'Paris'], country: 'DE', sections: ['main'], stand: 'H12', url: 'https://www.galeriedroste.com/'},
  ...
  {name: 'Galerie Ernst Hilger', cities: ['Wien'], country: 'AT', sections: ['main'], stand: 'E04', url: 'https://www.hilger.at/'},
  {name: 'Galerie Friese', cities: ['Berlin'], country: 'DE', sections: ['main'], stand: 'B06', url: 'https://www.galeriefriese.de/'},
  {name: 'Galerie Georg Nothelfer', cities: ['Berlin'], country: 'DE', sections: ['main'], stand: 'H01', url: 'https://www.galerie-nothelfer.de/de'},
  {name: 'Galerie Gisela Clement', cities: ['Bonn'], country: 'DE', sections: ['paper'], stand: 'B05.1', url: 'https://www.galerie-clement.de'},
  {name: 'Galerie Jochen Hempel', cities: ['Leipzig'], country: 'DE', sections: ['solo'], stand: 'I04', url: 'https://jochenhempel.com'},
  ...
  {name: 'Galerie Lætitia Gorsy', cities: ['Leipzig'], country: 'DE', sections: ['main'], stand: 'F08', url: 'https://www.shebam.art'},
  ...
  {name: 'Galerie Rupert Pfab', cities: ['Düsseldorf'], country: 'DE', sections: ['main'], stand: 'A17', url: 'https://www.galerie-pfab.com'},
  {name: 'Galerie Russi Klenner', cities: ['Berlin'], country: 'DE', sections: ['next'], stand: 'D11', url: 'https://www.russiklenner.de/'},
  {name: 'Galerie Steinek', cities: ['Wien'], country: 'AT', sections: ['solo'], stand: 'B02', url: 'http://www.steinek.at'},
  {name: 'Galerie Watson', cities: ['Hamburg'], country: 'DE', sections: ['friends'], stand: 'G02', url: 'https://www.galeriewatson.de/'},
  {name: 'Galerie Zink', cities: ['Waldkirchen'], country: 'DE', sections: ['main'], stand: 'H13', url: 'https://www.galerie-zink.com/home'},
  {name: 'Galerie3', cities: ['Wien', 'Klagenfurt'], country: 'AT', sections: ['solo'], stand: 'G12', url: 'https://galerie3.com/'},
  {name: 'Galleria Studio G7', cities: ['Bologna'], country: 'IT', sections: ['main'], stand: 'G10', url: 'https://galleriastudiog7.it'},
  {name: 'Gebr. Lehmann', cities: ['Dresden'], country: 'DE', sections: ['paper'], stand: 'B05.2', url: 'https://www.galerie-gebr-lehmann.de/'},
  {name: 'Gether Contemporary', cities: ['Kopenhagen'], country: 'DK', sections: ['main'], stand: 'A12', url: 'https://gethercontemporary.com'},
  {name: 'Gezwanzig', cities: ['Wien', 'Innsbruck'], country: 'AT', sections: ['next'], stand: 'A10', url: 'https://www.gezwanzig.com'},
  {name: 'Grölle', cities: ['Wuppertal', 'Düsseldorf'], country: 'DE', sections: ['main'], stand: 'J11', url: 'https://www.groelle.de'},
  {name: 'HOS Gallery', cities: ['Warschau'], country: 'PL', sections: ['next'], stand: 'D08', url: 'https://www.hosgallery.pl'},
  ...
  {name: 'Kaune Gallery', cities: ['Köln'], country: 'DE', sections: ['main'], stand: 'B01', url: 'https://www.kaunegallery.com/'},
  {name: 'Knust Kunz Galerie', cities: ['München'], country: 'DE', sections: ['paper'], stand: 'B05.4', url: 'https://www.sabineknust.com'},
  ...
  {name: 'Kornfeld Galerie', cities: ['Berlin'], country: 'DE', sections: ['main'], stand: 'J08', url: 'https://kornfeldgalerie.com'},
  ...
  {name: 'La Bibi + Reus', cities: ['Palma de Mallorca'], country: 'ES', sections: ['main'], stand: 'H04', url: 'https://labibigallery.com/'},
  {name: 'LABS Contemporary Art', cities: ['Bologna'], country: 'IT', sections: ['paper'], stand: 'B05.3', url: 'https://www.labsgallery.it/'},
  {name: 'Lage Egal Curatorial Projects', cities: ['Brüssel', 'Berlin'], country: 'BE', sections: ['main'], stand: 'A15', url: 'https://www.lage-egal.net'},
  {name: 'Linn Lühn', cities: ['Düsseldorf'], country: 'DE', sections: ['main'], stand: 'G06', url: 'https://linnluehn.com/'},
  {name: 'Lohaus Sominsky', cities: ['München'], country: 'DE', sections: ['main'], stand: 'H10', url: 'https://lohaussominsky.com/'},
  {name: 'Ludorff', cities: ['Düsseldorf'], country: 'DE', sections: ['main'], stand: 'J10', url: 'https://www.ludorff.com/'},
  {name: 'MAM Mario Mauroner Contemporary Art', cities: ['Salzburg'], country: 'AT', sections: ['main'], stand: 'J04', url: 'https://www.galerie-mam.com'},
  ...
  {name: 'Mazzoli', cities: ['Berlin', 'Modena'], country: 'DE', sections: ['main'], stand: 'D02', url: 'https://www.galleriamazzoli.com'},
  {name: 'NADAN', cities: ['Berlin'], country: 'DE', sections: ['friends'], stand: 'G02', url: 'https://nadan.org/'},
  {name: 'Nosbaum Reding', cities: ['Luxemburg', 'Brüssel'], country: 'LU', sections: ['main'], stand: 'C01', url: 'https://www.nosbaumreding.com/'},
  {name: 'Nouveaux Deuxdeux', cities: ['München'], country: 'DE', sections: ['next'], stand: 'H14', url: 'https://deuxdeux.de/'},
  {name: 'OstLicht. Gallery for Photography', cities: ['Wien'], country: 'AT', sections: ['main'], stand: 'J02', url: 'https://www.ostlicht.org/site/de/home'},
  {name: 'Patrick Heide Contemporary Art', cities: ['London', 'Brüssel'], country: 'GB', sections: ['paper'], stand: 'B05.6', url: 'https://www.patrickheide.com/'},
  {name: 'PAW', cities: ['Karlsruhe'], country: 'DE', sections: ['next'], stand: 'E07', url: 'https://pawgallery.de'},
  {name: 'Persons Projects', cities: ['Berlin'], country: 'DE', sections: ['main'], stand: 'G09', url: 'https://www.personsprojects.com/'},
  ...
  {name: 'Piero Atchugarry Gallery', cities: ['Miami', 'Garzón'], country: 'US', sections: ['main'], stand: 'E02', url: 'https://pieroatchugarry.com/'},
  {name: 'Produzentengalerie Hamburg', cities: ['Hamburg'], country: 'DE', sections: ['main'], stand: 'B03', url: 'https://www.produzentengalerie.com/'},
  {name: 'Rehbein Galerie', cities: ['Köln'], country: 'DE', sections: ['main'], stand: 'D03', url: 'https://rehbein-galerie.de/'},
  ...
  {name: 'Sevil Dolmaci', cities: ['Istanbul', 'Dubai'], country: 'TR', sections: ['main'], stand: 'C03', url: 'http://sevildolmaci.com'},
  {name: 'SEXAUER', cities: ['Berlin'], country: 'DE', sections: ['main', 'paper'], stand: 'A14', url: 'https://sexauer.eu/'},
  {name: 'Shore', cities: ['Wien'], country: 'AT', sections: ['friends'], stand: 'F07', url: 'https://shore-gallery.eu/'},
  ...
  {name: 'Soy Capitán', cities: ['Berlin'], country: 'DE', sections: ['friends'], stand: 'J05', url: 'https://soycapitan.de/'},
  ...
  {name: 'THK Gallery', cities: ['Kapstadt', 'Köln'], country: 'ZA', sections: ['main'], stand: 'H18', url: 'https://www.thkgallery.com'},
  {name: 'VAN HORN', cities: ['Düsseldorf'], country: 'DE', sections: ['main'], stand: 'H08', url: 'https://van-horn.net'},
  {name: 'Walter Storms Galerie', cities: ['München', 'Berlin'], country: 'DE', sections: ['solo'], stand: 'C02', url: 'https://www.storms-galerie.de/'},
